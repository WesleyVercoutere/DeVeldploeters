...
import { ICEComponent, ICEDeleteDialogComponent, ICEDeletePopupComponent, icePopupRoute, iceRoute, ICEUpdateComponent } from './';

const ENTITY_STATES = [...iceRoute, ...icePopupRoute];

@NgModule({
  imports: [DeVeldploetersSharedModule, RouterModule.forChild(ENTITY_STATES)],
  declarations: [ICEComponent, ICEUpdateComponent, ICEDeleteDialogComponent, ICEDeletePopupComponent],
