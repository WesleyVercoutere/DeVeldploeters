...
public class UserResource {
    ...
    private static final String ENTITY_NAME = "usesr";
    ...
    /**
     * {@code GET /activeUsers} : get all active users.
     *
     * @param pageable the pagination information.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body all users.
     */
    @GetMapping("/activeUsers")
    public List<UserDTO> getAllActiveUsers(@RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder, Pageable pageable) {
        return userService.findAllActiveUsers();
    }

    /**
     * {@code GET /activeMembers} : get all active members.
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body all users.
     */
    @GetMapping("/activeMembers")
    public List<MemberDTO> getAllActiveMembers() {
        return userService.findAllActiveMembers();
    }
